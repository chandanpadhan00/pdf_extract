...
def find_section_pages(pdf_path):
    ...
    return start_page, end_page, section_17_start_page, section_16_content

def extract_section_content(pdf_path, start_page, end_page, section_17_start_page, section_16_content, output_path):
    ...
    # If the 17th section starts on a new page, exclude that page
    if end_page == section_17_start_page:
...
def process_all_pdfs(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".pdf"):
            ...
            start_page, end_page, section_17_start_page, section_16_content = find_section_pages(pdf_path)

            if start_page is not None:
                output_filename = f"{os.path.splitext(filename)[0]}_16thSec.pdf"
                output_path = os.path.join(output_folder, output_filename)
                extract_section_content(pdf_path, start_page, end_page, section_17_start_page, section_16_content, output_path)
